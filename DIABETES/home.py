...
def app():
    ...
    st.image("DIABETES/Images/Diabetes-type-2.jpg",use_column_width=True)
    ...
    with col1:
        ...
        st.image("DIABETES/Images/polyuria.jpg", use_column_width=True)
        st.write("""
    ...
    with col2:
        ...
        st.image("DIABETES/Images/polydipsia.webp", use_column_width=True)
        st.write("""
    ...
    with col3:
        ...
        st.image("DIABETES/Images/polyphagia.webp", use_column_width=True)
        st.write("""
    ...
    with col4:
        with st.expander("SUDDEN WEIGHT LOSS "):
            st.image("DIABETES/Images/suddenweightloss.webp", use_column_width=True)
            st.write("""
    ...
    with col5:
        with st.expander("WEAKNESS "):
            st.image("DIABETES/Images/weakness.webp", use_column_width=True)
            st.write("""
    ...
    with col6:
        with st.expander("GENITAL THRUSH "):
            st.image("DIABETES/Images/genital thrush.webp", use_column_width=True)
            st.write("""
    ...
    with col7:
        with st.expander("VISUAL BLURRING "):
            st.image("DIABETES/Images/sight.webp", use_column_width=True)
            st.write("""
    ...
    with col8:
        with st.expander("ITCHING "):
            st.image("DIABETES/Images/itching.webp", use_column_width=True)
            st.write("""
    ...
    with col9:
        with st.expander("IRRITABILITY "):
            st.image("DIABETES/Images/irritability.webp", use_column_width=True)
            st.write("""
    ...
    with col10:
        with st.expander("DELAYED HEALING "):
            st.image("DIABETES/Images/delayed healing.webp", use_column_width=True)
            st.write("""
    ...
    with col11:
        with st.expander("PARTIAL PARESIS  "):
            st.image("DIABETES/Images/partialparesis.webp", use_column_width=True)
            st.write("""
    ...
    with col12:
        with st.expander("MUSCLE STIFFNESS "):
            st.image("DIABETES/Images/musclestiffness.webp", use_column_width=True)
            st.write("""
    ...
    with col13:
        with st.expander("ALOPECIA (HAIR LOSS)  "):
            st.image("DIABETES/Images/hairloss.webp", use_column_width=True)
            st.write("""
    ...
    with col14:
        with st.expander("OBESITY "):
            st.image("DIABETES/Images/obesity.webp", use_column_width=True)
            st.write("""
